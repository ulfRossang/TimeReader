...
public class CompetitionPartEntity implements Serializable {
    ...
    public CompetitionPartEntity(CompetitionEntity competition, long competitionPartId, String name, double compLength, String type, BigDecimal time) {
        this.competition = competition;
        this.competitionPartId = competitionPartId;
        this.name = name;
        this.compLength = compLength;
    ...
    protected CompetitionPartEntity() {
    }    
